...
//dopuniti funkcije
//ako nema ni jednog proslijeđenog parametra, vraćamo sve Evente
...
if(!empty($id)){
    $sql  = "SELECT Event.* FROM `Event` JOIN MyEvent ON MyEvent.idEvent = Event.id JOIN Users ON MyEvent.idUser=Users.idUsers WHERE Users.idUsers = '$id'";
